...
class AssignmentController
{
    public static function save()
    {
        ...
        // required fields
        $required = array("test_name", "course_id", "description", "deadline", "testtype_id");
        ...
        try {
            ...
            return json_encode(array("res_code" => "0", "res_data" => $test_id));
        } catch (\Throwable $th) {
            return json_encode(array("error_code" => "1"));
        }
    }
    ...
    public static function update()
    {
        ...
        // required fields
        $required = array("id", "test_name", "course_id", "description", "deadline", "testtype_id");
